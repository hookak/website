...
| Name | Description  | Example |
|---|---|---|
| longhorn_engine_rebuild_progress | Rebuild progress percentage of the engine (0–100). This metric is available only when a replica is being rebuilt. | longhorn_engine_rebuild_progress{pvc_namespace="default",pvc="testvol",engine="testvol-e-0",rebuild_src="10.42.1.215:20036",rebuild_dst="10.42.0.131:20922"} 42 |
